...
import { Pencil, Eye, Plus, Search, ArrowLeft } from "lucide-react";
...
const MemberReferences = () => {
  ...
  // Load references for the member
  ...
  useEffect(() => {
    loadReferences();
  }, [memberId, currentPage, searchTerm, statusFilter, sortBy, sortOrder]);
  ...
  return (
    <div className="container mx-auto py-6">
      ...
      {memberLoading ? (
        <div className="text-center py-10">Loading member details...</div>
      ) : !member ? (
        <div className="text-center py-10">Member not found</div>
      ) : (
        <>
          <Card className="mb-6">
            <CardHeader>
              <CardTitle>References Given by {member.memberName}</CardTitle>
              <CardDescription>
                View all references given by this member
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-wrap gap-4 mb-6">
                ...
                <Button onClick={() => navigate(`/references/create?memberId=${memberId}`)}>
              ...
              {loading ? (
                ...
                <div className="text-center py-10">
                  <p className="text-lg text-gray-500">No references found for this member</p>
                  <Button 
                    onClick={() => navigate(`/references/create?memberId=${memberId}`)} 
                    className="mt-4"
                  >
                    Add first reference
                  </Button>
